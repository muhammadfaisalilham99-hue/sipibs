...
<head>
    ...
    <title>Masuk Siswa - SIPIBS</title>
...
<body>
    <main class="auth-page">
        <section class="auth-brand">
            ...
            <div><span class="role-badge"><i class="bi bi-mortarboard-fill"></i> PORTAL SISWA</span></div>
            <h1 class="auth-title">Masuk Siswa</h1>
        ...
        <section class="auth-card">
            ...
            <form action="{{ route('login.post') }}" method="POST" autocomplete="off">
                ...
                <div class="form-row">
                    ...
                    <div class="field"><i class="bi bi-person-badge"></i><input id="nis" name="identity_number" type="text" value="{{ old('identity_number') }}" placeholder="Masukkan NIS Anda" autocomplete="username" readonly onfocus="this.removeAttribute('readonly')" required></div>
                </div>
                <div class="form-row">
                ...
                <button class="primary-btn" type="submit">Masuk sebagai Siswa</button>
            </form>
            <div class="auth-foot">Belum punya akun siswa?<a href="{{ url('/register') }}">Daftar di sini</a></div>
            <div class="switch-link">Anda guru atau staf? <a href="{{ url('/login-guru') }}">Login sebagai Guru</a></div>
        </section>
